...
set EXE=%BUILD_DIR%\donk-cli.exe
set ZIP=%BUILD_DIR%\donk-cli_%VERSION%_windows_amd64.zip
...
go build -trimpath -ldflags="-s -w -X github.com/richavery/donk-cli/internal/version.Version=%VERSION%" -o "%EXE%" "%ROOT%"
