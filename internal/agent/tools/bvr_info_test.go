...
func TestBvrInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildBvrInfo(cfg, nil, nil, nil, nil)
...
func TestBvrInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/bvr/bvr.json",
		"/project/.bvr/bvr.json",
	)
	output := buildBvrInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/bvr/bvr.json")
	require.Contains(t, output, "/project/.bvr/bvr.json")
}

func TestBvrInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildBvrInfo(cfg, mgr, nil, nil, nil)
...
func TestBvrInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_BeastmodeMode(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.bvr",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.bvr")
	require.Contains(t, output, "debug = true")
}

func TestBvrInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildBvrInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildBvrInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestBvrInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildBvrInfo(store, nil, nil, nil, nil)
...
func TestBvrInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "bvr-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("bvr-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildBvrInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "bvr-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestBvrInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "bvr-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestBvrInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestBvrInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
