...
func TestDonkInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildDonkInfo(cfg, nil, nil, nil, nil)
...
func TestDonkInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/donk/donk.json",
		"/project/.donk/donk.json",
	)
	output := buildDonkInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/donk/donk.json")
	require.Contains(t, output, "/project/.donk/donk.json")
}

func TestDonkInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildDonkInfo(cfg, mgr, nil, nil, nil)
...
func TestDonkInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_BeastmodeMode(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "mode = beastmode")
}

func TestDonkInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.donk",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.donk")
	require.Contains(t, output, "debug = true")
}

func TestDonkInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildDonkInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildDonkInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestDonkInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildDonkInfo(store, nil, nil, nil, nil)
...
func TestDonkInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "donk-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("donk-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildDonkInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "donk-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestDonkInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "donk-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestDonkInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestDonkInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
