...
const BvrInfoToolName = "bvr_info"

//go:embed bvr_info.md
var bvrInfoDescription string

type BvrInfoParams struct{}
...
func NewBvrInfoTool(
	...
	return fantasy.NewAgentTool(
		BvrInfoToolName,
		bvrInfoDescription,
		func(ctx context.Context, _ BvrInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildBvrInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		},
	)
}

func buildBvrInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
