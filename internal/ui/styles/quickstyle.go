...
func quickStyle(o quickStyleOpts) Styles {
	...
	s.Editor.PromptBeastmodeIconFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.fgMostSubtle).Background(o.busy).Bold(true).SetString(" Y ")
	s.Editor.PromptBeastmodeIconBlurred = s.Editor.PromptBeastmodeIconFocused.Foreground(o.bgBase).Background(o.fgMoreSubtle)
	s.Editor.PromptBeastmodeDotsFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.warningSubtle).SetString(":::")
	s.Editor.PromptBeastmodeDotsBlurred = s.Editor.PromptBeastmodeDotsFocused.Foreground(o.fgMoreSubtle)
	...
	s.Status.Help = lipgloss.NewStyle().Foreground(o.fgMoreSubtle)
	s.Status.ResourceLabel = lipgloss.NewStyle().Foreground(o.fgBase)
	...
	s.Status.ResourceValue = lipgloss.NewStyle().Foreground(o.fgBase)
