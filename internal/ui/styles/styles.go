...
type Styles struct {
	...
	Editor struct {
		...
		// BEASTMODE prompt (" ! " icon + ":::" dots).
		PromptBeastmodeIconFocused lipgloss.Style
		PromptBeastmodeIconBlurred lipgloss.Style
		PromptBeastmodeDotsFocused lipgloss.Style
		PromptBeastmodeDotsBlurred lipgloss.Style
