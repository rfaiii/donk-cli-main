...
type Workspace struct {
	...
	BEASTMODE bool           `json:"beastmode,omitempty"`
...
// UpdateAvailable is published when a newer DONK release is detected
...
// completion contract (notably `donk-cli run` in client/server mode)
...
// `donk-cli run`, which may attach to a busy session whose currently
